...
def generate_schedule(text: str):
    ...
    try:
        ...
        prompt = (
            ...
            "   - **시간 언급이 없는 경우 (종일)**:\n"
            "     -> \"allDay\": true 로 설정하세요.\n"
            "     -> \"start\"와 \"end\"는 반드시 **'YYYY-MM-DD'** 형식(시간 제외)으로 반환하세요. (예: '2025-11-28')\n"
            "   - **시간 언급이 있는 경우**:\n"
            "     -> \"allDay\": false 로 설정하세요.\n"
            "     -> \"start\"와 \"end\"는 **ISO 8601** 형식(YYYY-MM-DDTHH:mm:ss+09:00)을 사용하세요.\n"
            "     -> '오후 3시' 등은 24시간제로 변환 (15:00:00)\n\n"

            "⭐⭐[입력 패턴별 예시]⭐⭐\n"
            "Q: \"11월 28일 회식\" (시간 없음 -> 날짜만)\n"
            "A: {\"title\": \"회식\", \"start\": \"2025-11-28\", \"end\": \"2025-11-28\", \"allDay\": true}\n\n"
            
            "Q: \"내년 1월 5일 오후 2시 미팅\" (시간 있음 -> ISO 포맷)\n"
            "A: {\"title\": \"미팅\", \"start\": \"2026-01-05T14:00:00+09:00\", \"end\": \"2026-01-05T15:00:00+09:00\", \"allDay\": false}\n\n"
